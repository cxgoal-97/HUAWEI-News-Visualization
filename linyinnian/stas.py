...
import os
import json
path = "E:\\HUAWEI-News-Visualization\\linyinnian\\weibo"
a = os.listdir(path)
authors = set()
aucount = {}
austats = {}
dayscount = [0 for i in range(392)]
poscount = [0 for i in range(392)]
triposcount = [[0,0,0] for i in range(392)]
negcount = [0 for i in range(392)]
negposcount = [[0,0,0] for i in range(392)]
midcount = [0 for i in range(392)]
midposcount = [[0,0,0] for i in range(392)]
date = []
i = 0
...
wf = open("stats3.csv",encoding="utf-8",mode="w")
for i in range(392):
...
wf2 = open("aucount3.csv",encoding="utf-8",mode="w")
